...
const adminNav = [
  ...
  { to: '/admin/crm', label: 'CRM', icon: UserGroupIcon },
  { to: '/admin/staff-plans', label: 'Staff Plans', icon: StaffPlansIcon },
  { to: '/admin/program-schedule', label: 'Program Schedule', icon: CalendarDaysIcon },
  { to: '/admin/docs', label: 'Documentation', icon: BookOpenIcon },
  { to: '/admin/quarterly-reports', label: 'Quarterly Reports', icon: DocumentTextIcon },
];
...
function StaffPlansIcon({ className }) {
